...
setup(
    name='sopel_modules.morelike',
    version='0.1.0',
    description='Replace words in message with a list of configurable rhyming words',
    long_description=readme + '\n\n' + history,
    author='Shane Donohoe',
    author_email='shane@donohoe.cc',
    url='https://github.com/shanedabes/sopel-morelike',
